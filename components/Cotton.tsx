  ...
  return (
    <section id="cotton" className="py-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        >
          <p className="section-label">// cotton</p>
          <h2 className="heading-serif text-4xl sm:text-5xl text-on-surface leading-tight">
            Chief Morale{' '}
            <span className="text-primary italic">Officer.</span>
          </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {photos.map((photo, i) => (
            ...
            >
              <div
                className="bg-surface-container-lowest p-2 rounded-xl shadow-xl shadow-black/30 transition-transform duration-300 group-hover:rotate-0"
