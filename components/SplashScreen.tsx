  ...
  return (
    <AnimatePresence>
      {!exiting ? (
        <m.div
          key="splash"
          className="fixed inset-0 z-[100] bg-surface flex flex-col items-center justify-center px-6"
        >
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              <p className="text-on-surface/80 text-sm sm:text-base leading-relaxed">
                ...
                <br />
                <span className="text-on-surface/40">He made me greet you. I was napping.</span>
              </p>
              {/* Bubble tail */}
            ...
            <m.div
              ...
              className="w-36 h-36 sm:w-44 sm:h-44 rounded-full overflow-hidden border-2 border-outline-variant/20 bg-surface-container"
            >
              <img
                src="/images/c4.png"
                alt="Cotton"
            ...
            <m.p
              ...
              className="text-xs font-mono text-on-surface/30 tracking-wider"
            >
          ...
          >
            <button
              onClick={handleEnter}
              className="btn-ghost text-sm px-8 py-3 font-mono"
            >
              Come in &rarr;
            </button>
          </m.div>
        ...
        <m.div
          ...
          animate={{ opacity: 0 }}
          transition={{ duration: 0.5, ease: 'easeOut' }}
          className="fixed inset-0 z-[100] bg-surface pointer-events-none"
        />
      )}
    </AnimatePresence>
  )
